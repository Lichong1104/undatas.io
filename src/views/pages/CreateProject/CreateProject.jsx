...
function CreateProject() {
  ...
  const typeList = [
    ...
    },
    {
      type: "pdfParser",
      num: 211,
      title: t('CreateProject.CreateProject.9034112-6'),
      img: pdfParserImage,
  ...
  return (
    <Spin spinning={loading} tip={t('CreateProject.CreateProject.9034112-10')} indicator={<LoadingOutlined spin />} size="large">
      <MainBox>
        <Body className="custom-scroll">
          ...
          >
            <InputBox>
              ...
              <Form.Item label={<ItemTitle>{t('CreateProject.CreateProject.9034112-14')}</ItemTitle>} name="license" tooltip={t('CreateProject.CreateProject.9034112-13')}>
...
const Card = styled.div`
  ...
  &:hover {
    box-shadow: 0 0 10px 0 ${(props) => (props.$isActive ? "#2313d392" : "rgba(0, 0, 0, 0.217)")};
  }
  img {
    width: 100%;
    height: 170px;
