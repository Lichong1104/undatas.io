...
function PdfParser() {
  ...
  return (
    <Drawer title={t('FileDetail.PdfParser.903407-12')} onClose={onClose} placement="top" style={drawerStyle} open={drawerOpen}>
      <Spin spinning={loading} tip={t('FileDetail.PdfParser.903407-13')} indicator={<LoadingOutlined spin />} size="large">
        <MainBox>
          <Body>
          ...
          <Footer>
            <div>
              <Space size="large" >
                ...
                <Space ref={tourRef2}>{t('FileDetail.PdfParser.903407-16')} <InputNumber
                  min={1}
                  size="small"
                  style={{
                    width: 80,
                ...
                /> {t('FileDetail.PdfParser.903407-17')}</Space>
              ...
              <span>{t('FileDetail.PdfParser.903407-18')} {dataList.length} {t('FileDetail.PdfParser.903407-17')}</span>
            </div>
            <div>
              <Space size="large">
