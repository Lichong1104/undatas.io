  ...
  return (
    <MainBox>
      ...
      <UploadBox>
        ...
        <h1>{t('UploadData.UploadData.7725630-0')}{t('UploadData.UploadData.903409-0')}</h1>
        <h1 style={{ marginTop: "-12px" }}>{t('UploadData.UploadData.7725630-1')}{t('UploadData.UploadData.903409-6')}</h1>
        ...
        <Space ref={tourRef}>
          ...
          <Button icon={<FolderOpenOutlined />} onClick={() => folderInput.current.click()}>
            {t('UploadData.UploadData.903409-9')}{t('UploadData.UploadData.7725630-2')}
          </Button>
        </Space>
        ...
        <div style={{ marginTop: 12 }}>
          <p style={{ fontSize: 12, textAlign: "center" }}>{t('UploadData.UploadData.903409-0')}{t('UploadData.UploadData.7725630-3')}</p>
          <FileFormats>
            <div>
              <Space>
                <FundOutlined />
